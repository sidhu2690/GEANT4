...
def smart_scale_adc(img, noise_floor=4.0, adc_max=1_000_000):
    img = np.maximum(img - noise_floor, 0)
...
def process_root_file(in_file, prefix='evt', start_index=0, n_events=-1,
                      ...
                      base_dir='data', adc_scale=0.04, noise_floor=4.0,
                      adc_max=1_000_000, fixed_box=True, fixed_w=0.034249,
                      fixed_h=0.107281, seed=42):
    ...
    print(f"Settings: adc_scale={adc_scale}, noise_floor={noise_floor}, adc_max={adc_max}")
    ...
    for evt in range(n_events):
        ...
        # Smart scaling: noise floor removal + log compression
