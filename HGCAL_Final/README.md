...
| Stage | Signal Path | Pileup Path |
|-------|-------------|-------------|
| **1. Generation** | Geant4 Signal Sim | Pythia8 → Text |
| **2. Simulation** | Step1.root | Geant4 Pileup Sim |
| **3. Filtering** | Step1_trimmed.root | Step1_trimmed.root |
| **4. Digitization** | Step2.root | Step2.root |
| **5. Preparation** | - | Create nPU files |
| **6. Combination** | Signal + Random Pileup → ML Dataset |
...
```
Simulation_Data/
├── Electron_Step1/                    # Raw signal simulation
├── Electron_Step1_Filtered/           # Filtered signal
├── Electron_Step2/                    # Digitized signal
├── PileUp_Pythia_Data/               # Pythia8 pileup generation
├── Pileup_Step1_Data/                # Raw & filtered pileup
├── Pileup_Step2_Data/                # Digitised pileup files (various nPU)
└── Combined_Data/                     # Final ML-ready datasets
```
